...
class ExpensesTable extends StatelessWidget {
            ...
            child: Column(
              children: [
                if (expenses.isEmpty)
                  ...
                  ...expenses.map((e) => _buildMobileExpenseCard(context, e)).toList(),
              ],
            ),
          );
        }
  ...
  Widget _buildMobileExpenseCard(BuildContext context, ExpenseModel item) {
    final theme = Theme.of(context);
    final colors = theme.extension<AppColors>()!;
    final textColor = theme.colorScheme.onSurface;
    final isArabic = Get.locale?.languageCode == 'ar';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Divider(color: colors.borderColor.withOpacity(0.5), height: 1),
