                ...
                child: ListView(
                  ...
                  children: [
                    CustemTextField(
                      ...
                      hint: isArabic
                          ? 'مثال: مدير، موظف استقبال...'
                          : 'e.g. Manager, Receptionist...',
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: ctrl.selectedType.value == 'full'
                                      ? AppColor.primaryPurple.withValues(
                                          alpha: 0.1,
                                        )
                                      : Colors.transparent,
                                  border: Border.all(
                                    color: ctrl.selectedType.value == 'full'
                                        ...
                                        : borderColor,
                                    width: ctrl.selectedType.value == 'full'
                                        ? 2
                                        : 1,
                                  ),
                                  borderRadius: BorderRadius.circular(12),
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: ctrl.selectedType.value == 'partial'
                                        ? AppColor.primaryPurple
                                        : borderColor,
                                    width: ctrl.selectedType.value == 'partial'
                                        ? 2
                                        : 1,
                                  ),
                                  borderRadius: BorderRadius.circular(12),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Icon(
                                      ...
                                      color:
                                          ctrl.selectedType.value == 'partial'
                                          ? AppColor.primaryPurple
                                          : Colors.grey,
                                      size: 20,
                                    ),
