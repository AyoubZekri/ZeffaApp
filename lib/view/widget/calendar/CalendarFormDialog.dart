...
class _CalendarFormDialogState extends State<CalendarFormDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final double hPadding = isMobile ? 16.0 : 32.0;
          ...
          child: Obx(() {
            ...
            return Column(
              ...
              children: [
                ...
                Container(
                  padding: EdgeInsets.fromLTRB(hPadding, isMobile ? 20 : 28, hPadding, isMobile ? 16 : 20),
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: () => Get.back(),
                        icon: Icon(Icons.close_rounded, color: subtitleColor, size: isMobile ? 20 : 24),
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(hPadding, isMobile ? 16 : 20, hPadding, 0),
                  child: Container(
                ...
                // ── Footer Buttons ──
                Container(
                  padding: EdgeInsets.fromLTRB(hPadding, 16, hPadding, isMobile ? 16 : 24),
                  decoration: BoxDecoration(
  ...
  Widget _buildDatePickerTrigger({
    ...
    return FormField<DateTime>(
      key: ValueKey(
        "${label}_$currentVal",
      ), // Force rebuild and reset state when value changes, but keep it unique
