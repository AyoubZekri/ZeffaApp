                            ...
                            child: _buildCard(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  Text(
                                    (reservation.partyTypeName != null && reservation.partyTypeName!.isNotEmpty) ? reservation.partyTypeName! : reservation.typeOfPartyUuid,
                                    style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.bold,
                                      color: textColor,
                          ...
                          Container(
                            ...
                            child: _buildCard(
                              ...
                              Column(
                                ...
                                children: [
                                  _buildCardHeader(
                                    Get.locale?.languageCode == 'ar' ? 'الخدمات الإضافية' : 'Additional Services',
                                  ...
                                  Wrap(
                                    spacing: 8,
                                    runSpacing: 8,
                                    children: reservation.servicesNameList.isNotEmpty
                                        ? reservation.servicesNameList.map((name) => _buildChip(name)).toList()
                                        : [
                                            Text(
