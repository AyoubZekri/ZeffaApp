                ...
                children: [
                  ...
                  Obx(
                    () => TermsHeader(
                      ...
                      onFilterChanged: (val) =>
                          ctrl.selectedTypeFilter.value = val,
                      onAddPressed: () {
                        ctrl.clearFields();
                        Get.dialog(
                  ...
                  Expanded(
                    child: LayoutBuilder(
                      builder: (context, gridConstraints) {
                        ...
                        if (isMobile) {
                          crossAxisCount = 1;
                        } else if (gridConstraints.maxWidth < 750) {
                          crossAxisCount = 1;
                        } else if (gridConstraints.maxWidth < 1100) {
                          crossAxisCount = 2;
                        } else if (gridConstraints.maxWidth >= 1500) {
                          crossAxisCount = 4;
                        }
                                  ...
                                  gridDelegate:
                                      SliverGridDelegateWithFixedCrossAxisCount(
                                        ...
                                        mainAxisExtent: isMobile
                                            ? 260
                                            : 280, // Increased height to prevent overflow
                                      ),
