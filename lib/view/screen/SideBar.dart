                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        child: Obx(() {
                          final _ = controller.currentPage.value; // Register observable
...
class TopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      // Force rebuild on theme toggle
      final isDark = controller.isDarkMode.value;

      // Use explicit theme to guarantee instant reactivity
      final theme = isDark ? AppTheme.darkTheme : AppTheme.lightTheme;
      final colors = isDark ? AppColors.dark : AppColors.light;
      final textColor = theme.colorScheme.onSurface;

      return Container(
        height: isMobile ? 60 + topPadding : 70,
        margin: isMobile
            ? EdgeInsets.zero
            : const EdgeInsets.fromLTRB(32, 24, 32, 0),
        padding: EdgeInsets.fromLTRB(
          isMobile ? 8 : 24,
          isMobile ? topPadding : 0,
          isMobile ? 16 : 24,
          0,
        ),
        decoration: BoxDecoration(
